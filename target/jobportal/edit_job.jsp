                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="text-center text-success">
                                                    ...
                                                    <% int id=Integer.parseInt(request.getParameter("id")); JobDAO
                                                        dao=new JobDAO(DBConnect.getConn()); Jobs
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-control" name="status">
                                                                <option class="Active" value="<%=job.getStatus()%>">
                                                                    <%=job.getStatus()%>
                                                                </option>
                                                                <option class="Active" value="Active">Active</option>
                                                                <option class="Inactive" value="Inactive">Inactive
                                                                </option>
                                                            </select>
                                                        </div>
                                                    </div>
